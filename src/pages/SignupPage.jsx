...
function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://lqc1zbbfb0.execute-api.us-east-1.amazonaws.com/API-Latest/register', formData); // replace with your  signup  api endpoint
